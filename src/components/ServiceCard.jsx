  ...
  return (
    ...
    >
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 bg-white dark:bg-gray-700 p-3 rounded-full text-[#C8102E] shadow-xl transform group-hover:-translate-y-2 transition-transform">
          {icon}
        </div>
      </div>
      
      <div className="p-6">
        <h3 className="text-2xl font-serif text-[#1F2937] dark:text-white font-bold mb-3 group-hover:text-[#C8102E] transition-colors">{title}</h3>
